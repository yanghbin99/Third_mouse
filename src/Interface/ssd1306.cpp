...
uint8_t SSD1306_Init(void) {
	...
	SSD1306_WRITECOMMAND(0x10); //10, Page Addressing Mode
	...
	SSD1306_WRITECOMMAND(0x00); //-not offset		// 00 이었음
...
char SSD1306_Putc(char ch, FontDef_t* Font, SSD1306_COLOR_t color) {
	...
	for (i = 0; i < Font->FontHeight; i++) {
		b = Font->data[(ch - 65) * Font->FontHeight + i];
...
char SSD1306_Putc(char ch, FontDef_t* Font, SSD1306_COLOR_t color) {
	uint32_t i, b, j;
	uint32_t array_adress = SSD1306.CurrentX + SSD1306.CurrentY * 96;
	...
	{
		SSD1306_Buffer[array_adress + i] = 0x0;
		SSD1306_Buffer[array_adress + i] = Font->data[ch * 5 + i];
	}
